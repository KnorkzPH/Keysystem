...
local Config = {
    ...
    ServiceId       = 30529, -- Your PlatoBoost Service ID
    PlatoSecret     = "e0da732d-8e90-4fbf-98d9-fbf440647b08", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "0424", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://github.com/KnorkzPH/Keysystem/blob/main/script.lua"))()", -- The raw URL of your main script
    ...
    -- [5] File System
    KeyFileName     = "Karinderya", -- The name of the file where the valid key will be saved for auto-login
    ...
    HubName         = "Karinderya", -- The main title shown at the top of the GUI
    HubDescription  = "Toolkit" -- The text shown below the title
}
